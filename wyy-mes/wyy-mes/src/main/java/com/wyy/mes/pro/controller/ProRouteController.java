...
import com.wyy.mes.pro.domain.ProRoute;
import com.wyy.mes.pro.service.IProRouteService;
...
public class ProRouteController extends BaseController
{
    ...
    public AjaxResult add(@RequestBody ProRoute proRoute)
    {
        ...
        int rows = proRouteService.insertProRoute(proRoute);
        return rows > 0 ? AjaxResult.success(proRoute.getRouteId()) : AjaxResult.error("新增工艺路线失败");
    }
