...
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典类型表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_dict_type` VALUES (129, '生产工单类型', 'mes_workorder_type', '0', 'admin', '2026-08-31 00:00:00', '', NULL, '生产工单业务类型');
