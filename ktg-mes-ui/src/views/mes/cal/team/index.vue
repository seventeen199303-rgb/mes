<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="teamList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班组长" align="center" prop="leaderNick" />
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="班组长" prop="leaderUserId">
              <el-select v-model="form.leaderUserId" filterable clearable placeholder="选择接收班组任务的班组长" style="width: 100%" :disabled="optType === 'view'" @change="fillLeader">
...
export default {
  ...
  methods: {
    ...
    fillLeader(userId) {
      ...
      this.form.leaderUserName = user ? user.userName : null;
      this.form.leaderNick = user ? user.nickName : null;
    },
    // 取消按钮
    cancel() {
      this.open = false;
