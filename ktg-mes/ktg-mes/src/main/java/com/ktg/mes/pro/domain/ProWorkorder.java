...
public class ProWorkorder extends TreeEntity
{
    ...
    /** 工单类型：SELF自制、OUTSOURCE委外、PURCHASE外购 */
    @Excel(name = "工单类型")
    ...
    public String getEndProcessName()
    {
        return endProcessName;
    }

    public void setEndProcessName(String endProcessName)
    {
