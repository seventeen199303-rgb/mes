<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading"  stripe :data="iqcList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="来料检验单名称" align="center" prop="iqcName" :show-overflow-tooltip="true"/>
      <el-table-column label="供应商简称"  align="center" prop="vendorNick" :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="不合格数" width="90px" align="center" prop="quantityUnqualified" />
      <el-table-column label="检测结论" width="100px" align="center" prop="checkResult" >
        <template slot-scope="scope">
      ...
      <el-table-column label="检测人员" width="100px" align="center" prop="inspectorName" />
      <el-table-column label="单据状态" width="100px" align="center" prop="status" >
        <template slot-scope="scope">
