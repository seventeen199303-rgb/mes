...
) ENGINE = InnoDB AUTO_INCREMENT = 203 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典数据表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_dict_data` VALUES (200, 1, '自制', 'SELF', 'mes_workorder_type', NULL, 'primary', 'Y', '0', 'admin', '2026-08-31 00:00:00', '', NULL, '企业内部生产');
INSERT INTO `sys_dict_data` VALUES (201, 2, '委外', 'OUTSOURCE', 'mes_workorder_type', NULL, 'warning', 'N', '0', 'admin', '2026-08-31 00:00:00', '', NULL, '委托供应商加工');
INSERT INTO `sys_dict_data` VALUES (202, 3, '外购', 'PURCHASE', 'mes_workorder_type', NULL, 'info', 'N', '0', 'admin', '2026-08-31 00:00:00', '', NULL, '直接向供应商采购');
