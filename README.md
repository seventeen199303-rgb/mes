...
| 主数据：物料/产品设置 | 生产执行：生产排产 | 仓储：库存现有量 |
| --- | --- | --- |
| ![物料产品设置](wyy-mes/doc/设计文档/原型设计/截图/物料产品设置.png) | ![生产排产](wyy-mes/doc/设计文档/原型设计/截图/生产排产.png) | ![库存现有量](wyy-mes/doc/设计文档/原型设计/截图/库存现有量.png) |
